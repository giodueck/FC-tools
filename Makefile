...
all:
	...
	gcc src/fcc.c src/horizon/*_parser.c src/horizon/*_compiler.c src/helpers.c src/bp_creator.c -lz -g -o fcc
...
release:
	...
	gcc src/fcc.c src/horizon/*_parser.c src/horizon/*_compiler.c src/helpers.c src/bp_creator.c -lz -O3 -o fcc
